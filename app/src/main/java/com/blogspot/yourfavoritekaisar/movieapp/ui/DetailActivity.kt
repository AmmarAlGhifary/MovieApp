...
// Var ini bakal dipake sebagai kunci saat kita memindahkan intent extra ke Detail
...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rating = findViewById(R.id.rb_movie_rating)
    ...
    private fun populateDetails(extras: Bundle) {
        ...
        title.text = extras.getString(MOVIE_TITLE, "w300")
        rating.rating = extras.getFloat(MOVIE_RATING, 0f) / 2
        releaseDate.text = extras.getString(MOVIE_RELEASE_DATE, "w300")
        overview.text = extras.getString(MOVIE_OVERVIEW, "w300")
    }
}